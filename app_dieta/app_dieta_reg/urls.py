...
urlpatterns = [
    ...
    path('eliminar/dia_prec/<int:pk>/', eliminarDiaDietaPrecriaView.as_view(), name='eliminar_dieta_prec'),
    path('copiar_prec/', CopiarGuardarPrecriaView.as_view(), name='copiar_dietaprec'),
