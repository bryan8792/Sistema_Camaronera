...
from app_notaCredito.forms import CreditNoteForm, CreditNote, CreditNoteDetail
from app_venta.forms import *
        ...
        try:
            if action == 'add':
                with transaction.atomic():
                    ...
                    credit_note.receipt = Recibo.objects.get(voucher_type=VOUCHER_TYPE[1][0], establishment_code=credit_note.company.establishment_code, issuing_point_code=credit_note.company.issuing_point_code)
...
class CreditNoteClientListView(FormView):
