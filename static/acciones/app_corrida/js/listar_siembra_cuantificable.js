...
var tb_siembra_detalle;
var tabledev;

var siembra_detalle = {
    list: function () {
        tb_siembra_detalle = $('#tb_siembra_cuantificable').DataTable({
            language: {
                "oPaginate": {
                    "sFirst": "Primero",
                    "sLast": "Último",
...
$(function () {
    ...
    siembra_detalle.list();

    $('#tb_siembra_cuantificable tbody').on('click', 'a[rel="details"]', function () {
        var tr = tb_siembra_detalle.cell($(this).closest('td, li')).index();
        var data = tb_siembra_detalle.row(tr.row).data();
