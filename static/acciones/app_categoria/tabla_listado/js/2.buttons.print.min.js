    ...
    u.ext.buttons.print = {
        ...
        action: function (a, e, p, k) {
            ...
            if (c) {
                ...
                b(c.document.body).addClass("dt-print-views");
            ...
            } else e.buttons.info(e.i18n("buttons.printErrorTitle", "Unable to open print views"), e.i18n("buttons.printErrorMsg", "Please allow popups in your browser for this site to be able to views the print views."), 5E3)
        },
        title: "*",
        messageTop: "*",
        messageBottom: "*",
