        ...
        items: {
            "create": {
                ...
                callback: function (data, type, row) {
                    ...
                    location.href = '/planCuentas/crearPlanPSM/';
                    return true;
                }
            },
            "edit": {
                ...
                callback: function (key, options) {
                    ...
                    location.href = '/planCuentas/actualizarPlanPSM/' + nombresincortar;
                    return true;
                }
            },
            ...
            "delete": {
                ...
                callback: function (itemKey, opt, e) {
                    var nombresincortar = $(this).text().split(" ")[0].trim();
                    window.console && console.log(nombresincortar);
                    location.href = '/planCuentas/eliminarPlanPSM/' + nombresincortar;
                }
            },
            "sep1": "---------",
            "quit": {
