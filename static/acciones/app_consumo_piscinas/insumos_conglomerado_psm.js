...
function exportarExcel() {
    ...
    ws_data.push(['', '', '', '', '']);
    // Titulo centrado
    ws_data.push(['', '', 'RESUMEN CONSUMO PSM', '', '']);
    // Periodo
    ...
    XLSX.utils.book_append_sheet(wb, ws, 'Resumen Consumo Psm');
    XLSX.writeFile(wb, 'resumen_consumo_psm_' + moment().format('YYYY-MM-DD') + '.xlsx');
}
...
function imprimirReporte() {
    ...
    var printContent = `
        ...
        <html>
        <head>
            <title>Resumen Consumo Psm</title>
            <style>
