    ...
    tb_piscinas_por_insumos = $('#tb_piscinas_por_insumos').DataTable({
        ...
        initComplete: function (settings, json) {
            ...
            nuevo_ArrayObject.map(function (valor, indice) {
                console.log('valor del array', valor)
...
$(function () {
    ...
    /*$('#tb_piscinas_por_insumos tbody')
        .on('click', 'td.details-control', function () {
            var tr = $(this).closest('tr');
            var row = tb_piscinas_por_insumos.row(tr);
        ...
        .on('click', 'tr.group', function () {
            var currentOrder = tb_piscinas_por_insumos.order()[0];
            console.log(currentOrder);
            if (currentOrder[0] === groupColumn && currentOrder[1] === 'asc') {
                console.log(currentOrder)
                console.log(currentOrder[1])
                tb_piscinas_por_insumos.order([groupColumn, 'desc']).draw();
            } else {
                tb_piscinas_por_insumos.order([groupColumn, 'asc']).draw();
            }
        });*/
});