...
function generate_report_piscinas() {
    var parameters = {
        'action': 'search_piscinas_insumos_conglomerado',
        'start_date': date_now,
        'end_date': date_now,
    };
    ...
    tb_piscinas_por_insumos = $('#tb_piscinas_por_insumos_conglomerado').DataTable({
        destroy: true,
        lengthChange: false,
        fixedHeader: true,
        //responsive: true,
        ...
        initComplete: function (settings, json) {
            ...
            document.getElementById("tb_piscinas_por_insumos_conglomerado").innerHTML = table;
