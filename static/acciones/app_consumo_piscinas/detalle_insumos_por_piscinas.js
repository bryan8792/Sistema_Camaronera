...
function generate_report_insumos() {
    ...
    var groupColumn = 0;
    tb_insumos_por_piscinas = $('#tb_resumen_piscinas').DataTable({
        //responsive: true,
        autoWidth: false,
        destroy: true,
        deferRender: true,
        ...
        columnDefs: [
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    return parseFloat(data > 0 ? data : 0).toFixed(2);
                }
            },
            {
                targets: [-2],
                ...
                orderable: false,
                render: function (data, type, row) {
                    return parseFloat(data > 0 ? data : 0).toFixed(4);
                }
            },
            {
                targets: [-1],
                ...
                render: function (row, type, data) {
                    ...
                    return '<b>' + parseFloat(multiplicadora > 0 ? multiplicadora : 0).toFixed(2) + '</b>';
                }
            },
        ],
                    ...
                    if (last !== null) {
                        $(rows).eq(i - 1).after(
                            `<tr class="total">
                                ...
                                <td class="text-center" style="width: 15%;font-weight:700;background-color:rgb(255, 255, 255)">${total2.toFixed(2)}</td>   
                            </tr>`
                        );
                        total = 0;
                        total2 = 0;
        ...
        initComplete: function (settings, json) {
            //tb_insumos_por_piscinas.columns.adjust();
        }
    });
}
