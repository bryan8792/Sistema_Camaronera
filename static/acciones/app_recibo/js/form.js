                        ...
                        remote: {
                            ...
                            data: function () {
                                return {
                                    ...
                                    empresa_id: fv.form.querySelector('[name="empresa_id"]').value, // Enviar el valor de la empresa
...
$(function () {
    ...
    $('select[name="empresa_id"]') // Detectar cambios en el select empresa_id
        .on('change', function () {
            fv.revalidateField('voucher_type'); // Revalidar voucher_type
        });
