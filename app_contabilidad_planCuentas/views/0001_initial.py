    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_contabilidad_planCuentas.app_recibo')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('encabezadocuentaplan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app_contabilidad_planCuentas.encabezadocuentasplancuenta')),
                ('receipt', models.ForeignKey(limit_choices_to={'voucher_type__in': ['01', '08']}, on_delete=django.db.models.deletion.PROTECT, to='app_contabilidad_planCuentas.app_recibo', verbose_name='Tipo de comprobante')),
            ],
            options={
